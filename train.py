    ...
    torch.save(
        {
            ...
            # ── Vocab objects are needed by Transformer.infer() ──
...
def run_training_experiment() -> None:
    ...
    # Attach vocab so save_checkpoint embeds them in the checkpoint file.
    # This allows Transformer() (no-args) to reconstruct itself for inference.
